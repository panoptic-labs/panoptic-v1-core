...
contract CollateralTrackerTest is Test, PositionUtils {
    ...
    //             (tokensRequiredITM0, itmAmount0) = collateralToken0
    //                 .getITMPositionCollateralRequirement(Bob, tokenId, positionSize0, atTick);
    //             (tokensRequiredITM1, itmAmount1) = collateralToken1
    //                 .getITMPositionCollateralRequirement(Bob, tokenId, positionSize0, atTick);
    ...
    function test_Success_getPositionCollateralRequirement_ITMputSpread(
...

        {
            ...
            _assumePositionValidity(Alice, tokenId1, positionSize0 / 6);
            _spreadTokensRequired(tokenId1, positionSize0 / 6);
        ...
        // check requirement at fuzzed tick
        {
            ...
            uint128 required = _spreadTokensRequired(tokenId1, positionSize0 / 6);
